    ...
    while(nombre!=''):
        ...
        if(nombre!='' and email_!='EMAIL'):            
            mensaje_html = plantilla_html.format(
                ...
                article=f'<p>Hola {nombre},<br><br>Queremos recordarte que el curso "{curso_pf}" dará comienzo el próximo <b>28 de abril</b> y finalizará el <b>01 de junio</b>. Se trata de un curso tutorizado con seguimiento, \
