    ...
    while(nombre!=''):
        ...
        if(nombre!='' and email_!='EMAIL'):            
            mensaje_html = plantilla_html.format(
                ...
                article=f'<p>Hola {nombre},<br><br>Queremos recordarte que el curso "{curso_pf}" dará comienzo el próximo <b>5 de mayo</b> y finalizará el <b>8 de junio</b>. Se trata de un \
            ...
            if(curso_pf!=''):
                if (enviar_email(email_, mensaje_html, imagen_oculta_url, nombre + ' tu curso comienza el 5 de mayo')):
