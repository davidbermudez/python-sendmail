    ...
    while(nombre!=''):
        ...
        if(nombre!='' and email_!='EMAIL'):            
            mensaje_html = plantilla_html.format(
                ...
                article=f'<p>Hola {nombre},<br><br>Queremos recordarte que el curso "{curso_pf}" dará comienzo el <b>10 de noviembre</b> y finalizará el <b>18 de diciembre</b>. Se trata de un \
            ...
            if(curso_pf!=''):
                if (enviar_email(email_, mensaje_html, imagen_oculta_url, nombre + ', tu curso comenzará el 10 de noviembre')):
...
if __name__ == "__main__":
    archivo_csv = 'Documentoscopia.csv'
